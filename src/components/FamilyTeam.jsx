        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-md-6">
            <div className="about-text">
              ...
              <p>
                En todo el mundo existe un movimiento de familias Homeschoolers
                que decidimos educar con libertad. Asumimos nuestra
                responsabilidad constitucional para enseñarles a nuestros hijos
                desde casa.
                <br />
                Fue duro empezar. No sabíamos cómo hacerlo y la información era
                confusa. Costaba encontrar recursos para enseñar matemática o
                lengua a los chicos. Pero lo más difícil fue que nos sentíamos
                muy solos, porque éramos pocos y dispersos.
                <br />
